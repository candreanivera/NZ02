...
// 7. When you convert from Celsius to Fahrenheit, you often get a decimal number. (Don't worry about this just yet). 
// Log the temperature in farenheit to the console. -->


//***************************************************************************************/

//Declaring the constant for the temperature
const kelvin = 293;
// Transforming kelvin to celsius, substracting 273
let celsius = kelvin - 273;
// Transforming celsius to fahrenheit, through the following equation:
